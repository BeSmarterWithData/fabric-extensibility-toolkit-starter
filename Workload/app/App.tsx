...
import { ImpactIQItemEditor } from "./items/ImpactIQItem";
...
export function App({ history, workloadClient }: AppProps) {
    ...
    return <Router history={history}>
        ...
        <Switch>
            ...
            {/* Routings for the ImpactIQ Item Editor */}
            <Route path="/ImpactIQItem-editor/:itemObjectId">
                <ImpactIQItemEditor
                    workloadClient={workloadClient} data-testid="ImpactIQItem-editor" />
            </Route>
